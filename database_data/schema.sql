...
CREATE TABLE `info` (
  ...
  `name` varchar(255) COLLATE utf8mb3_czech_ci DEFAULT NULL,
  `text` varchar(255) COLLATE utf8mb3_czech_ci DEFAULT NULL,
...
CREATE TABLE `task` (
  ...
  `id_class` int DEFAULT NULL,
  `instructions` varchar(255) COLLATE utf8mb3_czech_ci DEFAULT NULL,
  `date` datetime DEFAULT NULL,
...
CREATE TABLE `user` (
  ...
  `login` varchar(255) COLLATE utf8mb3_czech_ci DEFAULT NULL,
  `name` varchar(255) COLLATE utf8mb3_czech_ci DEFAULT NULL,
...
-- Dump completed on 2024-03-21 10:01:46
